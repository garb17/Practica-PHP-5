...
<body id="repuesto">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top" style="background-color: #00002e !important;">
        <div class="container-fluid">
            ...
            <h3 style="color:white; float:center">REGISTRAR REPUESTO</h3>
    ...
    <section class="border-color-principal">
        <img src="assets/img/repuesto2.jpg" alt="Repuestos" width="100%" height="200px">
                ...
                <form action="" method="post" id="idFormulario">
                    <div class="contenido">
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control focus-ring focus-ring-warning border border-black" id="idSerial" onblur="verificarCedula()" placeholder=".form-control-sm" required>
                                    <label for="idSerial">Serial</label>
                                </div>
                            </div>  
                            ...
                            <div class="col-md-2 col-sm-3">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control focus-ring focus-ring-warning border border-black" id="idCantidad" placeholder=".form-control-sm" required>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control focus-ring focus-ring-warning border border-black" id="idModelo" placeholder=".form-control-sm" required >
                                    <label for="idModelo">Modelo</label>
                                </div>
                            </div>  
                            <div class="col-md-4 col-sm-4">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control focus-ring focus-ring-warning border border-black" id="idMarca" placeholder=".form-control-sm" required>
                                    <label for="idMarca">Marca</label>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control focus-ring focus-ring-warning border border-black" id="idCodigo" placeholder=".form-control-sm" required>
                                    <label for="idCodigo">Código de barra</label>
                                </div>
                            </div>
                        </div> 
                        <div class="row">
